...
mod tests {
    use super::*;
    use base::{FieldDefinitionExpression, Operator};
    use dms::condition::ConditionBase::Field;
    use dms::condition::ConditionExpression::Base;
    use dms::condition::{ConditionExpression, ConditionTree};
    use dms::select::{selection, JoinClause, SelectStatement};

    #[test]
    fn inner_join() {
        let str = "SELECT tags.* FROM tags \

...
mod tests {
    use super::*;
    use common::column::{ColumnConstraint, ColumnSpecification};
    use common::{FieldDefinitionExpression, Literal, Operator, SqlDataType, TableKey};

    use zz_condition::{ConditionBase, ConditionExpression, ConditionTree};
    ...
    fn sql_types() {
        ...
        let res = type_identifier(type0);
        assert_eq!(res.unwrap().1, SqlDataType::Bigint(20));
        let res = type_identifier(type1);
        assert_eq!(res.unwrap().1, SqlDataType::Varchar(255));
        let res = type_identifier(type2);
        assert_eq!(res.unwrap().1, SqlDataType::UnsignedBigint(20));
        let res = type_identifier(type3);
        assert_eq!(res.unwrap().1, SqlDataType::Bigint(20));
        let res = type_identifier(type2);
        assert_eq!(res.unwrap().1, SqlDataType::UnsignedBigint(20));
    }
    ...
    fn field_spec() {
        ...
        let res = field_specification_list(qstring);
        assert_eq!(
            res.unwrap().1,
            vec![
                ColumnSpecification::new(Column::from("id"), SqlDataType::Bigint(20)),
                ColumnSpecification::new(Column::from("name"), SqlDataType::Varchar(255)),
            ]
        );
    }
    ...
    fn simple_create() {
        ...
        assert_eq!(
            ...
            CreateTableStatement {
                ...
                fields: vec![
                    ColumnSpecification::new(Column::from("users.id"), SqlDataType::Bigint(20)),
                    ColumnSpecification::new(Column::from("users.name"), SqlDataType::Varchar(255)),
 ...
 iw_trans tinyint NOT NULL default 0
    ...
    fn compound_create_view() {
        use zz_compound_select::{CompoundSelectOperator, CompoundSelectStatement};
        ...
        assert_eq!(
            ...
            CreateTableStatement {
                ...
                fields: vec![
                    ...
                    ColumnSpecification::new(Column::from("comments.hat_id"), SqlDataType::Int(32)),
                ],
                keys: Some(vec![

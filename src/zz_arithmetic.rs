...
use crate::common_parsers::{
    as_alias, column_identifier_without_alias, integer_literal, type_identifier,
};
...
fn arithmetic_cast_helper(
    i: &str,
) -> IResult<&str, (ArithmeticBase, Option<SqlDataType>), VerboseError<&str>> {
...
mod tests {
    ...
    use common::column::{Column, FunctionArgument, FunctionExpression};

    use crate::zz_arithmetic::{
